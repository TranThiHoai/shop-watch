...
class Cart extends Component
{
    ...
    selectPayment = (e) =>
    {
        ...
        {
            this.setState({
                paymentMeth: 'VietComBank IB - 1245-343-2334-3433'
            })
        }
        else if (selectedPayment === '2')
        {
            this.setState({
                paymentMeth:  'Payment on delivery'
            })
        }
    }
                                        ...
                                        <table className="table table-hover" id="myTable">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="radio" name="bank" style={{verticalAlign:'top'}} onChange={this.selectPayment} value="1"/> VietComBank IB - 1245-343-2334-3433</td>
                                                    <td><input type="radio" name="bank" style={{verticalAlign:'top'}} onChange={this.selectPayment} value="2"/> Payment on delivery</td>
                                                    <td className="text-right">
                                                    </td>
                                                    <td></td>
                                                </tr>
